...
void testCommandProcessor(){
    ...
    string keyboard;
    bool isValid;
    string isQuitCommands;
    while(isQuitCommands != "q"){
        ...
        cout<<"If you want to quit the command entering stage please enter q otherwise enter c"<<endl;
        getline(cin,isQuitCommands);
    }
}
